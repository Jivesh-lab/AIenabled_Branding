/**
 * SignupBrandPanel
 * Left-side content overlay for the signup page.
 * Renders on the photo background (no opaque backing).
 */
  ...
  return (
    <div className="flex flex-col justify-center max-w-lg pr-8">
      ...
      <div className="flex gap-2 flex-wrap">
        {["BUILD", "INNOVATE", "COLLABORATE", "CREATE", "GROW"].map((w) => (
          <span key={w} className="text-[10px] font-bold tracking-[0.18em] text-slate-500 uppercase">
            {w}
          </span>
        ))}
      </div>
