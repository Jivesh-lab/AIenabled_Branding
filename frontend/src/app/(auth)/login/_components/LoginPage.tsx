 ...
 * - Edge-to-edge background image (innovation centre atrium)
 * - Top navigation bar overlaid on the photo
 * - Left content: tagline + feature pills + bottom labels
 * - Right content: frosted-glass login card
 * - Decorative blue organic shapes in corners
 */
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden flex flex-col">
      ...
      <div className="relative z-20 flex flex-1 items-center px-8 pb-8 lg:px-12 gap-8 lg:gap-16">
        ...
        {/* Right â€“ glass card */}
        <motion.div
          className="w-full lg:w-auto lg:min-w-[420px] lg:max-w-[460px] ml-auto"
      ...
      {/* -- Bottom-left corner labels (on top of the blue blob) ---- */}
