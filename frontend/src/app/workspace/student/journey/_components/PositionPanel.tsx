    ...
    <div className="flex flex-col gap-4">
      ...
      <Card className={cn("p-5", isRevision && "border-brand-gold/50")}>
        ...
        <div className="mt-4 flex flex-col gap-2">
          {isRevision && (
            <Link href={`/workspace/student/projects/${project.id}#feedback`} className={primaryLink}>
              View Feedback
            </Link>
          )}
          <Link
            href={isDraft ? "/workspace/student/submit" : `/workspace/student/projects/${project.id}`}
