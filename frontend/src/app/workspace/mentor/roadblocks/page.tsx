...
export default function StartupRoadblocksPage() {
  return (
    <PageContainer>
      <div className="flex flex-col gap-6 max-w-6xl mx-auto w-full py-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage and view your startup roadblocks details.</p>
        </div>
        ...
        <div className="bg-card border rounded-2xl p-8 flex flex-col gap-4 text-left text-muted-foreground mt-10 shadow-sm">
          <div className="flex items-center gap-3 border-b border-border/50 pb-4">
            <AlertCircle className="w-5 h-5 text-foreground opacity-70" />
